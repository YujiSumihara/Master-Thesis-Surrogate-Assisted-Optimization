...
%    
function [Cr, Sr, Nr, debug] = fill_avg(P, Nadd, precision, initial, final, lower_bound, upper_bound, deep_level, behavior, grid, D_factor, R_factor)
...
if nargin > 12 %sem uso - by YUJI
    error('Error: Too many inputs, fill_avg() requires at most 12 inputs.');
end
